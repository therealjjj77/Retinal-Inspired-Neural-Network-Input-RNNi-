...
#Changes in the Code from the default file are found in lines 1070 thru 1118(I'm sure there is a much more efficient implementation of the RNNi data preparation.)
...
# Create dataset
X, y, X_test, y_test = create_data_mnist('leftImg8bit')
...
# Add layers
model.add(Layer_Dense(X.shape[1], hdn))
model.add(Activation_ReLU())
model.add(Layer_Dense(hdn, hdn))
model.add(Activation_ReLU())
model.add(Layer_Dense(hdn, hdn))
model.add(Activation_ReLU())
model.add(Layer_Dense(hdn, 13))
...
model.train(X, y, validation_data=(X_test, y_test),
            epochs=10, batch_size=128, print_every=1000)
